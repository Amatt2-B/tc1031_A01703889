...
int lilysHomework(vector<int> arr) {
		...
		cout << "Swaps Ascending: " << swapsAsc << endl;
		cout << "Swaps Descending: " << swapsDesc << endl;
...
int main() {
		// Quitar el manejo de archivo y usar cout directamente
		...
		// Cambiar de fout a cout
		cout << result << "\n";

		// Cerrar el archivo (en este caso, no es necesario para la salida por consola)
		// fout.close();
